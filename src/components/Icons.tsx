export function HamburgerIcon() {
	return (
		<svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g clipPath="url(#clip0_2211_299)">
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M0 0H18V3H0V0ZM0 6H18V9H0V6ZM0 12H18V15H0V12Z"
					fill="#242A45"
				/>
			</g>
			<defs>
				<clipPath id="clip0_2211_299">
...
export function CancelIcon() {
	return (
		<svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g clipPath="url(#clip0_2211_289)">
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M7.99922 5.37895L13.3022 0.0749512L15.4242 2.19695L10.1192 7.49995L15.4232 12.803L13.3012 14.925L7.99922 9.61995L2.69622 14.924L0.574219 12.802L5.87922 7.49995L0.574219 2.19695L2.69622 0.0749512L7.99922 5.37895Z"
					fill="white"
				/>
			</g>
			<defs>
				<clipPath id="clip0_2211_289">
